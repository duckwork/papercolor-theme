" Theme: paperlesscolor
" Author: Case Duckworth <cased123@gmail.com>
" License: MIT
" Source: http://github.com/duckwork/papercolorless-theme
...
fun! s:set_highlightings_variable()
  ...
  call s:HL("Constant"      , s:foreground, "", "")
  call s:HL("String"        , s:foreground, "", "")
  call s:HL("Character"     , s:foreground, "", "")
  call s:HL("Number"        , s:foreground, "", "")
  call s:HL("Boolean"       , s:foreground, "", s:bold)
  call s:HL("Float"         , s:foreground, "", "")

  call s:HL("Identifier"    , s:foreground, "", "")
  call s:HL("Function"      , s:foreground, "", "")
  
  call s:HL("Statement"     , s:foreground, "", "none")
  call s:HL("Conditional"   , s:foreground, "", s:bold)
  call s:HL("Repeat"        , s:foreground, "", s:bold)
  call s:HL("Label"         , s:foreground, "", "")
  call s:HL("Operator"      , s:foreground, "", "none")
  call s:HL("Keyword"       , s:foreground, "", "")
  call s:HL("Exception"     , s:foreground, "", "")
  
  call s:HL("PreProc"       , s:foreground, "", "")
  call s:HL("Include"       , s:foreground, "", "")
  call s:HL("Define"        , s:foreground, "", "")
  call s:HL("Macro"         , s:foreground, "", "")
  call s:HL("PreCondit"     , s:foreground, "", "")

  call s:HL("Type"          , s:foreground, "", s:bold)
  call s:HL("StorageClass"  , s:foreground, "", s:bold)
  call s:HL("Structure"     , s:foreground, "", s:bold)
  call s:HL("Typedef"       , s:foreground, "", s:bold)
  ...
  call s:HL("SpecialComment", s:foreground, "", s:bold)
